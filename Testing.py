...
device = 0
MODEL_PATH = '/content/drive/MyDrive/Bert_models/bert_2'
...
path_input_docs = '/content/testing/'
...
for file in input_files:
	...
	if file not in ['.DS_Store', '196']:
		...
		seg_r_labels = []; seg_r = [];
		tmp = 0
		for line in open('/content/testing/'+file):
		...
		MAX_LEN = 256
		id_inputs = pad_sequences(id_inputs, maxlen=None, dtype="long", value=0, truncating="post", padding="post")
		attention_masks = []
